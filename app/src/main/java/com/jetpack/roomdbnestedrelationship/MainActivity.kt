package com.jetpack.roomdbnestedrelationship
...
import com.jetpack.roomdbnestedrelationship.ui.theme.LightGray100
import com.jetpack.roomdbnestedrelationship.ui.theme.Purple500
import com.jetpack.roomdbnestedrelationship.ui.theme.RoomDbNestedRelationshipTheme
import com.jetpack.roomdbnestedrelationship.viewmodel.UserViewModel
import com.jetpack.roomdbnestedrelationship.viewmodel.UserViewModelFactory
    ...
    Scaffold {
        Column(
            ...
            Column(
                ...
                Text(text = "Nested Relationship", color = Color.White, fontWeight = FontWeight.Bold, fontSize = 20.sp)
            }
            Column(
                modifier = Modifier
                    .fillMaxWidth()
